...
- **20.4 Speaking honesty**: relabel the conversation speaking number as a "fluency practice" metric; route exam-simulation pronunciation through Azure phoneme-level assessment (already integrated for practice) instead of transcript inference.
