...
| 2   | App Store Connect app record (`com.simplemart.companion`) | https://appstoreconnect.apple.com                                                                                                                                                               | Free once §1.1 active                                    |
...
| 5   | Google Play app record (`com.simplemart.companion`)    | Play Console → Create App                                                                                                                                                                       | Free once §1.4 active                                    |
