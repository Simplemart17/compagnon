...
|---|---------|-------|--------------|
| P0-1 | TCF specifications are wrong (listening 39q/35min, reading 45q/60min, grammar 18q/18min — code uses 29/25, 29/45, 18/15) | `src/lib/constants.ts:14-17`, `src/lib/prompts/mock-test.ts:81-94` | pedagogy |
